/* eslint-disable object-property-newline, quote-props, no-dupe-keys */
// Character map from https://github.com/django/django/blob/3c447b108ac70757001171f7a4791f493880bf5b/django/contrib/admin/static/admin/js/urlify.js
const characterMap = {
  // Latin
...
/* eslint-enable object-property-newline, quote-props, no-dupe-keys */
...
// Function from https://developer.mozilla.org/en/docs/Web/JavaScript/Guide/Regular_Expressions#Using_special_characters
function escapeRegExp(str) {
  return str.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'); // $& means the whole matched string
}

function transliterate(str) {
  return str.split('').map(c => characterMap[c] || c).join('');
}

function parameterize(str, options) {
